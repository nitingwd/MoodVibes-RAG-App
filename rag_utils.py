...
from langchain_community.document_loaders import PyPDFLoader, CSVLoader, TextLoader  # ✅ updated import
...
# Initialize sentence transformer embeddings (free HuggingFace model)
